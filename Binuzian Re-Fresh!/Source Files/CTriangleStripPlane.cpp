/* * * * * * * * * * * * * * * * * * * * * * * *
*	File Name *	CTriangleStripPlane.cpp    	   *
...
[in] verticesAlongLength - Number of vertices along the length
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
void CTriangleStripPlane::GeneratePosition2TexturedWithHeight(cuCustomVertex::Position2Textured** ppVertices, int verticesAlongWidth, int verticesAlongLength, UCHAR* pHeight)
{
	SAFE_DELETE_ARRAY(*ppVertices);
